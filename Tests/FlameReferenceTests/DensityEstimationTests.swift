...
final class DensityEstimationTests: XCTestCase {
    func testPassthroughWhenDisabled() {
        ...
        for i in 0..<h.counts.count { h.counts[i] = 5; h.colors[i] = SIMD3<Double>(0.2, 0.3, 0.4) }
    ...
    func testCountsPreservedExactly() {
        ...
        h.counts[c] = 1000; h.colors[c] = SIMD3<Double>(1, 1, 1)
        h.counts[h.binIndex(3, 4)] = 2; h.colors[h.binIndex(3, 4)] = SIMD3<Double>(0.1, 0.2, 0.3)
