...
final class ParamChannelParityTests: XCTestCase {
    ...
    func testCanonicalOrderGrewTo33NoDupes() throws {
        XCTAssertEqual(Variations.canonicalOrder.count, 42)
        XCTAssertEqual(Set(Variations.canonicalOrder).count, 42, "duplicate canonical name")
    ...
    func testBytesPerXform() throws {
        XCTAssertEqual(GPUXform.floatsPerXform, 393)
        XCTAssertEqual(GPUXform.bytesPerXform, 1572)
