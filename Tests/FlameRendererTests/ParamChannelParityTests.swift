...
final class ParamChannelParityTests: XCTestCase {
    ...
    func testCanonicalOrderGrewTo33NoDupes() throws {
        XCTAssertEqual(Variations.canonicalOrder.count, 87)
        XCTAssertEqual(Set(Variations.canonicalOrder).count, 87, "duplicate canonical name")
    ...
    func testBytesPerXform() throws {
        XCTAssertEqual(GPUXform.floatsPerXform, 798)
        XCTAssertEqual(GPUXform.bytesPerXform, 3192)
