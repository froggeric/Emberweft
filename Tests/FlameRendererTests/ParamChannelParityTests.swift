...
final class ParamChannelParityTests: XCTestCase {
    ...
    func testCanonicalOrderGrewTo33NoDupes() throws {
        XCTAssertEqual(Variations.canonicalOrder.count, 49)
        XCTAssertEqual(Set(Variations.canonicalOrder).count, 49, "duplicate canonical name")
    ...
    func testBytesPerXform() throws {
        XCTAssertEqual(GPUXform.floatsPerXform, 456)
        XCTAssertEqual(GPUXform.bytesPerXform, 1824)
