...
final class ParamChannelParityTests: XCTestCase {
    ...
    func testCanonicalOrderGrewTo33NoDupes() throws {
        XCTAssertEqual(Variations.canonicalOrder.count, 44)
        XCTAssertEqual(Set(Variations.canonicalOrder).count, 44, "duplicate canonical name")
    ...
    func testBytesPerXform() throws {
        XCTAssertEqual(GPUXform.floatsPerXform, 411)
        XCTAssertEqual(GPUXform.bytesPerXform, 1644)
