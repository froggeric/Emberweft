...
> **Complete (v0.4.0):** `emberweft export` ships H.264 + HEVC export to MP4/MOV
> via AVFoundation, with progress, cancellation, long-form segment+concat, and
> batch. Frames are byte-identical to `animate`. Engine parity unchanged. See
> [CHANGELOG.md](../../CHANGELOG.md) and the M6 spec/plan under
> `docs/superpowers/specs|plans/2026-08-02-m6-export-pipeline-design.md`.
